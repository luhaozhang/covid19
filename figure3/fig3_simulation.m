...
% Import data
        ...
        s1_b_total_day = surv_5p_s_ddimer(:,1);
        s1_b_total_data = surv_5p_s_ddimer(:,2);
        s1_b_neg = surv_5p_s_ddimer(:,3);
        s1_b_pos = surv_5p_s_ddimer(:,4);
        ...
        s2_b_total_day = death_5p_s_ddimer(:,1);
        s2_b_total_data = death_5p_s_ddimer(:,2);
        s2_b_neg = death_5p_s_ddimer(:,3);
        s2_b_pos = death_5p_s_ddimer(:,4);
...
v_cal(v_cal<=10)=1;
sol1.y(1,:) = v_cal;
scatter(v1_total_day,v1_total_data,84, '^', 'DisplayName','Virus','MarkerEdgeColor', [0.88,0.14,0.14], 'MarkerFaceColor',[0.88,0.14,0.14]);
hold on; plot( sol1.x, sol1.y(1,:), 'Linewidth', 3,'DisplayName','Fit','Color', [0.88,0.14,0.14]); % Virus
hold on;
...
'MarkerEdgeColor',[0.88,0.14,0.14],'MarkerFaceColor',[0.88,0.14,0.14],'Color',[0.88,0.14,0.14])
hold on; plot( sol1.x, T01 * ones(size(sol1.x)) - sol1.y(2,:),  'Linewidth', 3,'Color',[0.88,0.14,0.14]); % Activated innate immune cells
hold on;
...
% A
subplot(2,3,3);
scatter(a1_total_day,a1_total_data, 84, '^','DisplayName','Virus','MarkerEdgeColor', [0.88,0.14,0.14],'MarkerFaceColor',[0.88,0.14,0.14]);
hold on; plot( sol1.x, sol1.y(3,:),  'Linewidth', 3,'Color',[0.88,0.14,0.14]); % Activated innate immune cells
hold on;
...
'MarkerEdgeColor',[0.88,0.14,0.14],'MarkerFaceColor',[0.88,0.14,0.14],'Color', [0.88,0.14,0.14])
hold on; plot( sol1.x, sol1.y(4,:),  'Linewidth', 2, 'DisplayName','Fit','Color',[0.88,0.14,0.14], 'Linewidth', 3); 
hold on;
...
%D-dimer
subplot(2,3,5);
errorbar(s1_b_total_day, s1_b_total_data, s1_b_neg, s1_b_pos,'^','MarkerSize',10,...
'MarkerEdgeColor',[0.88,0.14,0.14],'MarkerFaceColor',[0.88,0.14,0.14],'Color', [0.88,0.14,0.14])
hold on; plot( sol1.x, sol1.y(5,:), 'Linewidth', 3,'DisplayName','Fit','Color',[0.88,0.14,0.14]); % Virus
hold on;
errorbar(s2_b_total_day, s2_b_total_data, s2_b_neg, s2_b_pos,'s','MarkerSize',10,...
'MarkerEdgeColor',[0,0,0],'MarkerFaceColor',[0,0,0],'Color', [0,0,0])
...
scatter(s1_h_total_day,s1_h_total_data, 84, '^','DisplayName','Virus','MarkerEdgeColor', [0.88,0.14,0.14],'MarkerFaceColor',[0.88,0.14,0.14]);
hold on; 
plot( sol1.x, sol1.y(6,:), 'Linewidth', 3,'DisplayName','Fit','Color',[0.88,0.14,0.14]); % Virus
hold on;
